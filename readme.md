...
After setting up the repository, head to [getting started](index.md) to get familiar with your new knowledge base!
...
- [getting-started](index.md) - learn how to use your Foam workspace
